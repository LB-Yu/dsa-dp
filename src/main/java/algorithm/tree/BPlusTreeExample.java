...
public class BPlusTreeExample<K extends Comparable<? super K>, V> {
  ...
  public BPlusTreeExample(int branchingFactor) {
    ...
    while (!queue.isEmpty()) {
      ...
      while (!queue.isEmpty()) {
        ...
        while (it.hasNext()) {
          ...
          if (it.hasNext())
            sb.append(", ");
          if (node instanceof BPlusTreeExample.InternalNode)
